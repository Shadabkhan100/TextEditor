    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <Link className="nav-link" to={"/about"}>about</Link>
          {/* <a className="nav-link" href="./aboutus.js">{props.info}</a>   </li> */}
     
      </ul>
      <div className={`form-check form-switch mx-50 text-${props.mode==='light' ?'dark':'light'}`}>
  <input  className="form-check-input " type="checkbox" onChange={mytext} onClick={props.toggleMode} role="switch" id="flexSwitchCheckDefault"/>
